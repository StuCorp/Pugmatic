...
//        game.run();
    ...
    public void whenNudge1Clicked(View view){
        ...
        public void refreshDisplay(){
            ...
            nudgeDisplay.setText(game.machine.getNudges().toString());
            holdDisplay.setText(game.machine.getHoldsNum().toString());
            creditDisplay.setText(game.machine.getUserMoney().toString());
            winningsDisplay.setText(game.machine.getPayOutTracker().toString());
